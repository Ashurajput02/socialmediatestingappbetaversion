import '../trending_posts_page/widgets/post_item_widget.dart';
    ...
    return SafeArea(
        child: Scaffold(
            body: Container(
                ...
                child: Column(
                    children: [SizedBox(height: 17.v), _buildPost(context)]))));
  }
        ...
        child: BlocSelector<TrendingPostsBloc, TrendingPostsState,
            ...
            builder: (context, trendingPostsModelObj) {
              return StaggeredGridView.countBuilder(
                  ...
                  itemCount: trendingPostsModelObj?.postItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    PostItemModel model =
                        trendingPostsModelObj?.postItemList[index] ??
                            PostItemModel();
                    return PostItemWidget(model);
                  });
            }));
  }
}
