...
import 'twitter_item_model.dart';
...
class FriendsModel extends Equatable {
  FriendsModel({
    this.twitterItemList = const [],
    this.followItemList = const [],
  }) {}

  List<TwitterItemModel> twitterItemList;
  ...
  FriendsModel copyWith({
    ...
    return FriendsModel(
      twitterItemList: twitterItemList ?? this.twitterItemList,
      followItemList: followItemList ?? this.followItemList,
    );
  }

  @override
  List<Object?> get props => [twitterItemList, followItemList];
}
