...
import 'package:testbetaversion125november2023/presentation/messages_page/models/messages_model.dart';
...
class MessagesBloc extends Bloc<MessagesEvent, MessagesState> {
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        messagesModelObj: state.messagesModelObj?.copyWith(
            ...
            richardalvesItemList: fillRichardalvesItemList())));
  }
  ...
  List<RichardalvesItemModel> fillRichardalvesItemList() {
    return [
